...
'S'= Sample space = \cbrak{1,2,3,4,5,6} \\
 'A'= Event that number is even = \lcbrak2,4,\rcbrak6 \\
...
Now,
\begin{align*}
&\pr A=\frac{n\brak{A}}{n\brak{S}}=\frac{3}{6}=\frac{1}{2}   \leavevmode \\ 
&\pr B=\frac{n\brak{B}}{n\brak{S}}=\frac{3}{6}=\frac{1}{2}    \leavevmode \\
&\pr{AB}=\frac{n\brak{AB}}{n\brak{S}}=\frac{1}{6}   
\end{align*}
